...
<title>Login &mdash; Car Shop Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage salespeople and cars in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages salespeople</li>
            <li>&#10003; Salespeople manage cars</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Salesperson</a>
            </p>
