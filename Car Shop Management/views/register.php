...
<title>Register &mdash; Car Shop Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <h1>Join as a Salesperson</h1>
        <p>Create your account to start managing cars in the car shop system.</p>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="muted">Register as a salesperson</p>
